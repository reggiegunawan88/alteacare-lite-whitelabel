...
const UpdatePatient = () => {
  const { patientData, selectedPatient, selectAppointmentPatient, updateAppointmentPatient } = useBottomsheetPatient();
  return (
    <div className="flex z-50 flex-col py-5 mx-5 space-y-4">
      <p className="text-lg font-bold">Ubah Pasien :</p>
      ...
      <button
        onClick={updateAppointmentPatient}
